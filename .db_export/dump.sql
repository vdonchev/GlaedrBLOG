...
INSERT INTO `posts` (`id`, `authorId`, `title`, `body`, `createdOn`, `updatedOn`, `deletedOn`) VALUES
	...
	(8, 10, 'Конструктор (обектно-ореинтирано програмиране)', 'В обектно-ориентираното програмиране конструкторът е блок от инструкции, който се изпълнява за инициализация на един обект при неговото създаване. Практически конструкторът може да извършва всякакъв вид действия, но ако не друго, то е поне признак за много лош стил на програмиране да се изполва за действия, които не засягат пряко създавания обект, тъй като това може да доведе до неочаквани грешки, особено в големи програми. В езика за програмиране C++ конструкторът се представя като член-функция на един обект, носеща същото име като него. Тя и деструкторът са единствените типове дефиниции на функции, за които не се дефинира тип на връщания резултат. В тази статия примерите са дадени на този език.', '2017-03-10 08:20:03', '2017-03-10 08:20:09', NULL),
	...
	(14, 10, 'Едсхер Дейкстра', 'Едсхер Дейкстра (понякога неправилно изписвано Дийкстра; на нидерландски: Edsger Wybe Dijkstra, нидерландско произношение: [ˈɛtsxər ˈwibə ˈdɛɪkstra]) е нидерландски информатик.', '2017-03-10 08:23:16', '2017-03-10 08:23:21', NULL),
